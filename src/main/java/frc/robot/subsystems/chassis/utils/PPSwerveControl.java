...
public class PPSwerveControl extends CommandBase implements Sendable {
  private final Timer timer = new Timer();
  private final PathPlannerTrajectory trajectory;
  private final Supplier<Pose2d> poseSupplier;
  private final SwerveDriveKinematics kinematics;
  private final PPSwervePid controller;
  ...
  private static BiConsumer<Translation2d, Rotation2d> logError =
      PPSwerveControl::defaultLogError;
  ...
  public PPSwerveControl(
    ...
    this.controller = new PPSwervePid(xController, yController, rotationController);
    controller.setTolerance(new Pose2d(new Translation2d(xController.getPositionTolerance(),yController.getPositionTolerance())
      , Rotation2d.fromDegrees(rotationController.getPositionTolerance())));
  ...
  public static void setLoggingCallbacks(
    ...
    PPSwerveControl.logActiveTrajectory = logActiveTrajectory;
    PPSwerveControl.logTargetPose = logTargetPose;
    PPSwerveControl.logSetpoint = logSetpoint;
    PPSwerveControl.logError = logError;
  }
